...
experiment Demo type: gui autorun:true{
	...
	output {
		...
		keystone: [{-0.16294351554416142,-0.21473069507800835,0.0},{-0.1977541756831414,1.2514826794278986,0.0},{1.0581412089555293,1.1932576255702068,0.0},{1.0651774062176642,-0.19656117472525347,0.0}]
